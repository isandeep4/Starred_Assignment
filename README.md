...
This job search dashboard application includes the following features:

- **Dashboard Overview**: Main dashboard displaying user profile, saved jobs count, recommended jobs, and recent search history
...
- **Data Fetching**: Efficient data management using React Query (TanStack Query)
- **API Integration**: RESTful API endpoints for job data retrieval and search

## Project Setup

This project uses Next.js with TypeScript for type safety and modern development practices.
